...
class TilePlaceable : public Node {
   ...
   protected:
    ...
    std::map<StringName, TNode *> entries_;
    TileManager *tile_manager_;
    Callable tile_manager_ready_cb_;

    void setup_tile_manager_(Node *node);
    ...
    virtual void handle_entry_clicked_(StringName entry_name){};
   ...
   public:
    ...
    inline TNode *get_entry(const StringName name) const {
